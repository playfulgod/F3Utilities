...
import com.techygeek.f3utilities.root_tools;
...
public class SDhacksActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File dir = new File ("/data/data/com.techygeek.f3utilities/sdhack");
        dir.mkdirs();
        CopyAssets();
    }
    ...
    public void start(View view) {
        //user is perssy4pie
        String kernelInstall = "busybox dd if=/data/data/com.techygeek.f3utilities/sdhack/pressy4pie-cwm-unofficial-sd-data.lok of=/dev/block/platform/msm_sdcc.1/by-name/boot";
        root_tools.execute(kernelInstall);
        Log.i(tagname, "The sdcard hack boot image was installed.");

        String recoveryInstall = "busybox dd if=/data/data/com.techygeek.f3utilities/sdhack/pressy4pie-cwm-unofficial-sd-data.lok of=/dev/block/platform/msm_sdcc.1/by-name/recovery";
    ...
    private void CopyAssets() {
        ...
        for(String filename : files) {
            ...
            try {
                ...
                out = new FileOutputStream("/data/data/com.techygeek.f3utilities/sdhack/" + filename);
                copyFile(in, out);
                in.close();
                in = null;
                out.flush();
